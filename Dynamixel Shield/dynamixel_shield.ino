...
void loop() {
  ...
  dxl.setGoalPosition(DXL_ID1, 1023);
  dxl.setGoalPosition(DXL_ID2, 1023);
  delay(1000);
...
//  delay(1000);
  ...
  dxl.setGoalPosition(DXL_ID, 800, UNIT_DEGREE);
  delay(1000);
  dxl.setGoalPosition(DXL_ID1, 800, UNIT_DEGREE);
  delay(1000);
  dxl.setGoalPosition(DXL_ID2, 800, UNIT_DEGREE);
  delay(1000);
